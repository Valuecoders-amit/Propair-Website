...
@Component({
  selector: 'app-new-exchange-view-message',
  templateUrl: './new-exchange-view-message.component.html',
  styleUrls: ['./new-exchange-view-message.component.scss']
})
export class NewExchangeViewMessageComponent implements OnInit {
...
dropdownSettings :IDropdownSettings= {
  ...
  enter(){
    ...
    // this.details.tags = this.tempTags
      ...
      update(){
        ...
        this.studentService.updateMessage(payload,this.studentId).subscribe(data =>{
          ...
          this.toasterService.success('Sucess', data['message'])
            this.router.navigateByUrl(`/student-module/dashboard/new-exchange-view-message/${this.studentId}`)
          }else{
          this.toasterService.error('Error', data['message'])
