...
@Component({
  selector: 'app-propair-view-message',
  templateUrl: './propair-view-message.component.html',
  styleUrls: ['./propair-view-message.component.scss']
})
export class PropairViewMessageComponent implements OnInit {
