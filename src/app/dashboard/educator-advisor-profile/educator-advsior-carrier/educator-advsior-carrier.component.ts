...
@Component({
  selector: 'app-educator-advsior-carrier',
  templateUrl: './educator-advsior-carrier.component.html',
  styleUrls: ['./educator-advsior-carrier.component.scss']
})
export class EducatorAdvsiorCarrierComponent implements OnInit {
