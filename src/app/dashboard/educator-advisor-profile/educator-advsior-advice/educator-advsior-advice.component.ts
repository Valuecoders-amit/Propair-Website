...
@Component({
  selector: 'app-educator-advsior-advice',
  templateUrl: './educator-advsior-advice.component.html',
  styleUrls: ['./educator-advsior-advice.component.scss']
})
export class EducatorAdvsiorAdviceComponent implements OnInit {
