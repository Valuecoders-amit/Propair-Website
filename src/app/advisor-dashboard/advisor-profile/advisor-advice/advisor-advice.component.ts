...
@Component({selector: 'app-advisor-advice', templateUrl: './advisor-advice.component.html', styleUrls: ['./advisor-advice.component.scss']})
export class AdvisorAdviceComponent implements OnInit {
    career : Array<any>=[];
