...
@Component({
  selector: "app-advisor-career",
  templateUrl: "./advisor-career.component.html",
  styleUrls: ["./advisor-career.component.scss"],
})
export class AdvisorCareerComponent implements OnInit {
  ...
  editCareer(career, template: TemplateRef<any>) {
    if (career.endDate) {
      ...
      this.addPosition.setValue({
        ...
        image: (career.image ? career.image : "assets/images/company.png") || "assets/images/company.png"
      });
    } else {
